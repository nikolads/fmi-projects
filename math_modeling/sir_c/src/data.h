...
sir::SimulResult target_m5 = sir::SimulResult({
    sir::DataPoint(263.75, 1.25, 0.00, 1.00),
    sir::DataPoint(263.75, 1.25, 0.00, 2.00),
    sir::DataPoint(263.75, 1.25, 0.00, 3.00),
    sir::DataPoint(263.75, 1.25, 0.00, 4.00),
    sir::DataPoint(263.25, 1.75, 0.00, 5.00),
    sir::DataPoint(262.75, 2.25, 0.00, 6.00),
    sir::DataPoint(262.50, 2.50, 0.00, 7.00),
    sir::DataPoint(262.00, 3.00, 0.00, 8.00),
    sir::DataPoint(261.00, 4.00, 0.00, 9.00),
    sir::DataPoint(260.25, 4.75, 0.00, 10.00),
    sir::DataPoint(258.75, 6.25, 0.00, 11.00),
    sir::DataPoint(257.00, 8.00, 0.00, 12.00),
    sir::DataPoint(254.00, 10.00, 1.00, 13.00),
    sir::DataPoint(250.75, 13.00, 1.25, 14.00),
    sir::DataPoint(246.00, 17.75, 1.25, 15.00),
    sir::DataPoint(238.75, 25.00, 1.25, 16.00),
    sir::DataPoint(233.00, 30.75, 1.25, 17.00),
    sir::DataPoint(226.25, 37.00, 1.75, 18.00),
    sir::DataPoint(215.25, 47.50, 2.25, 19.00),
    sir::DataPoint(204.75, 57.75, 2.50, 20.00),
    sir::DataPoint(196.75, 65.25, 3.00, 21.00),
    sir::DataPoint(185.00, 76.00, 4.00, 22.00),
    sir::DataPoint(175.00, 85.25, 4.75, 23.00),
    sir::DataPoint(163.25, 95.50, 6.25, 24.00),
    sir::DataPoint(149.25, 107.75, 8.00, 25.00),
    sir::DataPoint(136.50, 117.50, 11.00, 26.00),
    sir::DataPoint(125.50, 125.25, 14.25, 27.00),
    sir::DataPoint(114.50, 131.50, 19.00, 28.00),
    sir::DataPoint(107.00, 131.75, 26.25, 29.00),
    sir::DataPoint(98.50, 134.50, 32.00, 30.00),
    sir::DataPoint(88.25, 138.00, 38.75, 31.00),
    sir::DataPoint(78.00, 137.25, 49.75, 32.00),
    sir::DataPoint(73.50, 131.25, 60.25, 33.00),
    sir::DataPoint(65.25, 131.50, 68.25, 34.00),
    sir::DataPoint(60.00, 125.00, 80.00, 35.00),
    sir::DataPoint(55.00, 120.00, 90.00, 36.00),
    sir::DataPoint(52.00, 111.25, 101.75, 37.00),
    sir::DataPoint(49.00, 100.25, 115.75, 38.00),
    sir::DataPoint(46.25, 90.25, 128.50, 39.00),
    sir::DataPoint(43.25, 82.25, 139.50, 40.00),
    sir::DataPoint(41.75, 72.75, 150.50, 41.00),
    sir::DataPoint(40.50, 66.50, 158.00, 42.00),
    sir::DataPoint(40.00, 58.50, 166.50, 43.00),
    sir::DataPoint(38.75, 49.50, 176.75, 44.00),
    sir::DataPoint(37.75, 40.25, 187.00, 45.00),
    sir::DataPoint(37.50, 36.00, 191.50, 46.00),
    sir::DataPoint(36.50, 28.75, 199.75, 47.00),
    sir::DataPoint(36.00, 24.00, 205.00, 48.00),
    sir::DataPoint(35.25, 19.75, 210.00, 49.00),
    sir::DataPoint(35.00, 17.00, 213.00, 50.00),
    sir::DataPoint(34.75, 14.25, 216.00, 51.00),
    sir::DataPoint(34.75, 11.50, 218.75, 52.00),
    sir::DataPoint(34.75, 8.50, 221.75, 53.00),
    sir::DataPoint(34.50, 7.25, 223.25, 54.00),
    sir::DataPoint(34.25, 6.25, 224.50, 55.00),
    sir::DataPoint(34.25, 5.75, 225.00, 56.00),
});
...
sir::SimulResult target_m3 = sir::SimulResult({
